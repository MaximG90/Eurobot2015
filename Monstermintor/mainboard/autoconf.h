...
#define CONFIG_MODULE_ARDUINO 1
...
/*
 * Encoders (you need comm/spi for encoders_hctl)
 */
...
#undef  CONFIG_MODULE_encoders_hctl
#undef  CONFIG_MODULE_encoders_hctl_CREATE_CONFIG
#define CONFIG_MODULE_ENCODERS_HCTL 1
#define CONFIG_MODULE_ENCODERS_HCTL_CREATE_CONFIG 1
...
#define CONFIG_AVRDUDE_PROG_AVRISP2 1
