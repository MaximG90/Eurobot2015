...
int8_t ANSI_NORMAL[5] = { 27, '[', '0', 'm', 0 };
int8_t ANSI_RED[6] = { 27, '[', '3', '1', 'm', 0 };
int8_t ANSI_GREEN[6] = { 27, '[', '3', '2', 'm', 0 };
int8_t ANSI_YELLOW[6] = { 27, '[', '3', '3', 'm', 0 };
int8_t ANSI_BLUE[6] = { 27, '[', '3', '4', 'm', 0 };
int8_t ANSI_MAGENTA[6] = { 27, '[', '3', '5', 'm', 0 };
int8_t ANSI_CYAN[6] = { 27, '[', '3', '6', 'm', 0 };
int8_t ANSI_WHITE[6] = { 27, '[', '3', '7', 'm', 0 };

void textcolor(int8_t color[])
{
	int8_t i;
	for (i = 0; i < sizeof(color); i++)
		printf_P(PSTR("%c"), color[i]);
}
...
void mylog(struct error *e, ...)
{
	...
	case E_TRAJECTORY:
		...
		break;
	case E_BLOCKING_DETECTION_MANAGER:
		textcolor(ANSI_MAGENTA);
		break;
	case E_OA:
		textcolor(ANSI_CYAN);
		break;
...
static volatile int cmdline_stop = 0;
